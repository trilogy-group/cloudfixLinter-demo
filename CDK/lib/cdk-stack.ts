  ...
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    new ec2.Instance(this, `cloudfix-instance-appserver-ckd`, {
      ...
      machineImage: new ec2.GenericLinuxImage({
        'us-west-2': 'ami-09d56f8956ab235b3',
      }),
      vpc: DefaultVpc,
    ...
    //s3 Bucket - 1
    const bucket = new s3.Bucket(this, 'cloudfix-s3-1-cdk-1', {
      bucketName: "cloudfix-s3-bucket-1",
      versioned: true,
      accessControl: s3.BucketAccessControl.PRIVATE,
    });

    const bucket2 = new s3.Bucket(this, 'cloudfix-s3-2-cdk-2', {
    ...
    //neptune DBCluster
    const cluster = new neptune.DatabaseCluster(this, 'MyCluster', {
